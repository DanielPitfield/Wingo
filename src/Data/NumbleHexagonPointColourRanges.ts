...
export const hexagon25_pointColourRanges: NumblePointColourRange[] = [
...
export const hexagon64_pointColourRanges: NumblePointColourRange[] = [
...
export const hexagon100_pointColourRanges: NumblePointColourRange[] = [
