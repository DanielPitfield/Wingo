export const wordHintMappings = [
    ...
    { word: "elderberry", hint: "Small, black-purple berry considered by some as a healing agent, particularly for colds and flus" },
    { word: "elongation", hint: "This answe is increasing in length" },
    { word: "employment", hint: "This answer is being paid to work" },
    { word: "engagement", hint: "This answer is going to get married" },
    { word: "engagement", hint: "This answer is signing up for a new course at a new school" },
